...
class _$SignInFormEventTearOff {
  ...
  _EmailChanged emailChanged({required String emailStr}) {
    return _EmailChanged(
      emailStr: emailStr,
    );
  }

  _PasswordChanged passwordChanged({required String passwordStr}) {
...
abstract class _EmailChanged implements SignInFormEvent {
  const factory _EmailChanged({required String emailStr}) = _$_EmailChanged;
...
abstract class _PasswordChanged implements SignInFormEvent {
  const factory _PasswordChanged({required String passwordStr}) =
      _$_PasswordChanged;
...
class _$_SignInFormState implements _SignInFormState {
  ...
  @override
  String toString() {
    return 'SignInFormState(emailAddress: $emailAddress, password: $password, showErrorMessage: $showErrorMessage, isSubmitting: $isSubmitting, authFailureOrSuccess: $authFailureOrSuccess)';
  }
